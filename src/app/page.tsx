...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-amber-50 via-sky-50 to-slate-100 flex items-center justify-center px-6">
