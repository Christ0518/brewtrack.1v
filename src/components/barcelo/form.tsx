            ...
            <div className="min-h-screen flex items-center justify-center bg-slate-100 px-4">
                <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-lg p-6 sm:p-8">
                    <div className="mb-6 text-center">
                        <h1 className="text-2xl font-bold text-slate-900">Barcelo Login</h1>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                    className={`w-full border ${theme.accentBorderClass} ${theme.accentRingClass} rounded-lg px-4 py-2.5 pr-10 outline-none`}
                                />
                                <button
                                    type="button"
